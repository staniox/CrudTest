...
namespace CrudTest.Migrations
{
    public partial class initialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DocumentoIdentificacoes",
                columns: table => new
                {
                    DocumentoIdentificacaoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UsuarioId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentoIdentificacoes", x => x.DocumentoIdentificacaoId);
                    table.ForeignKey(
                        name: "FK_DocumentoIdentificacoes_Usuarios_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentoIdentificacoes_UsuarioId",
                table: "DocumentoIdentificacoes",
                column: "UsuarioId",
                unique: true);
